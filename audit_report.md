...
**Date**: 2026-04-30T10:08:02.229699
**Duration**: 126.38s
...
| stateful recovery | +10 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:34`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:44`<br>+1 more |
| token-efficient context layer | +10 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:104`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:207`<br>+1 more |
...
| RAG governance | +8 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:107`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:206`<br>+1 more |
| before/after evidence logging | +8 | `.agchk/OPTIMIZATION_COMPLETED.md:3`<br>`.agchk/OPTIMIZATION_COMPLETED.md:22`<br>+1 more |
| capability table | +8 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:78`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:109`<br>+1 more |
...
| impression cues | +8 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:98`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:112`<br>+1 more |
...
| remote tool boundary | +8 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:115`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:219`<br>+1 more |
| scheduler/workers | +8 | `.agchk/self_audit_mechanism.md:227`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:100`<br>+1 more |
| semantic VFS | +8 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:117`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:216`<br>+1 more |
...
| learning assetization | +7 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:120`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:215`<br>+1 more |
...
| skill memory | +7 | `.plans/openai-api-server.md:146`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:21`<br>+1 more |
...
| handoff/workbook habit | +6 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:48`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:127`<br>+1 more |
| hands-on validation | +6 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:128`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:214`<br>+1 more |
...
| constraint adaptation | +5 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:131`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:211`<br>+1 more |
| context compaction | +5 | `.plans/streaming-support.md:618`<br>`.plans/streaming-support.md:620`<br>+1 more |
| pattern extraction | +5 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:133`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:210`<br>+1 more |
| small-step landing | +5 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:134`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:212`<br>+1 more |
| source-level learning | +5 | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:145`<br>`AGCHK-ARCHITECTURE-AUDIT-20260430.md:275`<br>+1 more |
...
| Role-play handoff orchestration detected | HIGH | -10 (rule 5 + severity 5) | `AGCHK-ARCHITECTURE-AUDIT-20260430.md:144`<br>+2 more | Keep one agent or loop responsible for the full user intent. Use subagents for independent evidence gathering or context isolation, then merge results back to the intent owner. ... |
...
- `code` run_agent.py:1631 — Found 19460 orchestration markers across 5 coordination categories (delegation, planning, recovery, routing, scheduling).
...
- `code` AGCHK-ARCHITECTURE-AUDIT-20260430.md:144 — Found 160 role markers across 5 role categories (builder, manager, planner, researcher, reviewer) and 2239 serial handoff markers.
- `code` RELEASE_v0.7.0.md:158 — Detected 660 tool/command dispatch sites and permission enforcement signals, but 659 dispatch sites were not near a permission check.
...
**Symptom**: Found 19460 orchestration markers across 5 coordination categories (delegation, planning, recovery, routing, scheduling).
...
**Symptom**: Found 160 role markers across 5 role categories (builder, manager, planner, researcher, reviewer) and 2239 serial handoff markers.
...
**Evidence**:
- `AGCHK-ARCHITECTURE-AUDIT-20260430.md:144`
- `AGCHK-ARCHITECTURE-AUDIT-20260430.md:237`
...
**Symptom**: Detected 660 tool/command dispatch sites and permission enforcement signals, but 659 dispatch sites were not near a permission check.
...
- `AGCHK-AUDIT-20260430.json:1667`
- `AGCHK-AUDIT-20260430.json:1682`
- `AGCHK-AUDIT-20260430.json:1697`
- `AGCHK-AUDIT-20260430.json:1712`
- `AGCHK-AUDIT-20260430.json:1727`
- `AGCHK-AUDIT-20260430.json:1757`
- `AGCHK-AUDIT-20260430.json:1772`
- `AGCHK-AUDIT-20260430.json:1787`
**Confidence**: 66%
